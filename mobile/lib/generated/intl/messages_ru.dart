...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m28(sizeInMBorGB) => "Освободите ${sizeInMBorGB}";
  ...
  static String m32(expiryTime) => "Ссылка истечёт через ${expiryTime}";
  ...
  static String m35(albumName) => "Успешно перемещено в ${albumName}";
  ...
  static String m39(toEmail) => "Пожалуйста, напишите нам на ${toEmail}";

  static String m40(toEmail) => "Пожалуйста, отправьте логи на \n${toEmail}";

  static String m41(storeName) => "Оцените нас в ${storeName}";
  ...
  static String m44(endDate) => "Обновление подписки на ${endDate}";

  static String m45(count) =>
      "${Intl.plural(count, one: '${count} результат найден', other: '${count} результатов найдено')}";

  static String m46(count) => "${count} выбрано";

  static String m47(count, yourCount) => "${count} выбрано (${yourCount} ваши)";
  ...
  static String m52(emailIDs) => "Поделиться с ${emailIDs}";
  ...
  static String m55(fileType) => "Этот ${fileType} будет удалён из Ente.";

  static String m56(storageAmountInGB) => "${storageAmountInGB} Гигабайт";
  ...
  static String m59(endDate) => "Ваша подписка будет отменена ${endDate}";

  static String m60(completed, total) => "${completed}/${total} сохранено";
  ...
  static String m64(endDate) => "Действителен по ${endDate}";

  static String m65(email) => "Подтвердить ${email}";

  static String m66(email) => "Мы отправили письмо на <green>${email}</green>";

  static String m67(count) =>
      "${Intl.plural(count, one: '${count} год назад', other: '${count} лет назад')}";

  static String m68(storageSaved) => "Вы успешно освободили ${storageSaved}!";
